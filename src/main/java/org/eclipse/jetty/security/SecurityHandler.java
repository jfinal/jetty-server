...
public abstract class SecurityHandler extends HandlerWrapper implements Authenticator.AuthConfiguration
{
        ...
        throws Exception
    {
        ...
        if (_identityService==null)
        {
            ...
            // Modified by JFinal System.err.println("Null identity service, trying login service: "+_identityService);
            if (_identityService==null)
                _identityService=findIdentityService();
            
            // Modified by JFinal System.err.println("Finding identity service: "+_identityService);
        ...
        if (_loginService!=null)
        {
            // Modified by JFinal System.err.println("LoginService="+_loginService + " identityService="+_identityService);
